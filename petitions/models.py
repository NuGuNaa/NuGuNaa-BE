...
class Petition(models.Model):
    BILL_NO = models.OneToOneField(Petition_Detail, primary_key=True, null=False, blank=False, on_delete=models.CASCADE)
    file_bill_no = models.OneToOneField(Petition_File, null=False, blank=False, on_delete=models.CASCADE)
